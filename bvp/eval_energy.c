...
*energy=(*(e+26))*(-3*pow((*(e+25)),2) + pow((*(e+26)),2))*(*(e+36)) + (pow((*(e+25)),2) + pow((*(e+26)),2))*(*(e+37)) + pow(pow((*(e+25)),2) + pow((*(e+26)),2),2)*(*(e+38)) + pow((*(e+24)),2)*(*(par+2)) + (pow((*(e+1)),2) + pow((*(e+2)),2) + pow((*(e+4)),2))*(*(par+3)) + (pow((*(e+30)),2) + pow((*(e+31)),2) + pow((*(e+32)),2) + pow((*(e+33)),2) + pow((*(e+34)),2) + pow((*(e+35)),2))*pow((*(par+4)),2);
}